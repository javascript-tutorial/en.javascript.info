...
Their main advantages are that they have weak references to objects, so they can easily be removed by the garbage collector.

That comes at the cost of not having support for `clear`, `size`, `keys`, `values`, etc.
