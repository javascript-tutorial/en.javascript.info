...
There's also "Visual Studio Code", not to be confused with "Visual Studio". "Visual Studio" is well-suited IDE for the .NET platform. It's also good for JavaScript.Detailed information about the difference between "Visual Studio" and "Visual Studio Code" can be found in [Visual Studio Code FAQ](https://code.visualstudio.com/docs/supporting/faq) page.
