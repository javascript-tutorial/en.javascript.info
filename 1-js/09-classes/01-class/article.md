...
Sometimes people say that `class` is a "syntax sugar" (syntax that is designed to make things easier to read or to express) in JavaScript, because we could actually declare the same without `class` keyword at all:
