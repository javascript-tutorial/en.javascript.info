...
A bigger example with fetching user information for an array of GitHub users by their names (We could fetch an array by their IDs, and the logic would be identical.):
