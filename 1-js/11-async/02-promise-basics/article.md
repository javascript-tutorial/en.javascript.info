...
If a promise is pending, `.then/catch/finally` handlers wait for it (the handlers are not called). Otherwise, if a promise has already settled, they execute immediately:
