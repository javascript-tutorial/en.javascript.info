...
To demonstrate the use of callbacks, promises and other abstract concepts, we'll be using some browser methods: specifically, creating scripts and performing simple document manipulations.
