...
The remainder operator may also be referred to as the modulo operator, but note that the remainder operator is not the same as the modulo operator and they produce different results in certain situations. There is no modolus operation in JavaScript.
