...
When a programmer is sure that the variable should never change, he or she can use `const` to guarantee it, and also to clearly show that fact to everyone.
