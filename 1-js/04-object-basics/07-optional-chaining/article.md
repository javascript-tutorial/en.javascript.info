...
Still, we should apply `?.` carefully, only where it's acceptable that the left part doesn't need to exist. So that it won't hide programming errors from us, if they occur.
