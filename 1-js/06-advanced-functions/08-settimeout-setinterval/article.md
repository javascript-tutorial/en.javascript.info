...
And here is a example with simulation of a server
```js
// Dummy data of a dummy web server.
const array = [
    ...
    {status:"failed",content:""},
    {status:"success",content:"The way to get started is to quit talking and begin doing : Unknown"},
