...
```warn header="Internet Explorer and Edge in early versions: no support for `x/y`"
Internet Explorer and Edge in its early non-Chromium-based versions (12-18) don't support `x/y` properties for historical reasons.
