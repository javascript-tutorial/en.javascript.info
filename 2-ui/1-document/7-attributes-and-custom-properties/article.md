...
**Свойство создаётся, лишь если атрибут в принципе может быть у элемента.**
...
...Ну а для кросс-браузерного кода мы можем получать такие атрибуты через `getAttribute`.
