...
There's a method called `document.elementFromPoint(clientX, clientY)`. It returns the topmost Element at the specified coordinates (or `null` if given coordinates are out of the window).
