...
Not bad, but there's a side-effect. To initiate the drag'n'drop can we `mousedown` anywhere on the ball? If we do it at the edge, then the ball suddenly "jumps" to become centered.
