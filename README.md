...
|----------|--------|-------------------|----------------|-------------|-----------|
| Chinese | [xitu/javascript-tutorial-zh](https://github.com/xitu/javascript-tutorial-zh) | @leviding | ![](http://translate-hook.javascript.info/stats/zh.svg) | ![](https://img.shields.io/github/last-commit/xitu/javascript-tutorial-zh.png?link=https://github.com/xitu/javascript-tutorial-zh&maxAge=1800) | https://zh.javascript.info |
